...
import com.indivaragroup.woi.mobile.awsgateway.outbound.CardlessEndpoint;
import lombok.Data;
...
@Data
@Configuration
@ConfigurationProperties(prefix = "outbound.cardless-withdrawal.http-client")
public class CardlessHttpClientConfiguration {
  ...
  @Bean
  public OkHttpClient cardlessHttpClient(CardlessHttpClientConfiguration configuration) {
  ...
  @Bean
  public Retrofit cardlessRetrofit(
      CardlessHttpClientConfiguration configuration,
      @Qualifier("cardlessHttpClient") OkHttpClient httpClient
  ) {
  ...
  @Bean
  public CardlessEndpoint cardlessEndpoint(
      @Qualifier("cardlessRetrofit") Retrofit retrofit
  ) {

    return retrofit.create(CardlessEndpoint.class);
  }
}
