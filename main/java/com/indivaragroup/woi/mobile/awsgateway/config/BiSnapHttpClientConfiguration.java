...
import com.indivaragroup.woi.mobile.awsgateway.outbound.BiSnapEndpoint;
import lombok.Data;
...
@Data
@Configuration
@ConfigurationProperties(prefix = "outbound.bi-snap.http-client")
public class BiSnapHttpClientConfiguration {
    ...
    @Bean
    public OkHttpClient biSnapHttpClient(BiSnapHttpClientConfiguration configuration) {
    ...
    @Bean
    public Retrofit biSnapRetrofit(
            BiSnapHttpClientConfiguration configuration,
            @Qualifier("biSnapHttpClient") OkHttpClient httpClient
    ) {
    ...
    @Bean
    public BiSnapEndpoint biSnapServiceEndpoint(@Qualifier("biSnapRetrofit") Retrofit retrofit) {
        return retrofit.create(BiSnapEndpoint.class);
    }
}
